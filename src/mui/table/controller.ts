 ...
 */
export function analyzeTableData(data: any) {
  ...
  throw new Error(`Data can only be an object or array. A(n) [${type}] was given.`)
}
 ...
 * @param obj
 */
export function getTableViewColumns(obj: any) {
  const data = analyzeTableData(obj)
